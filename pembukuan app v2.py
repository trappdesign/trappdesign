...
class AplikasiPembukuan:
    ...
    def setup_tab_stock(self):
        # Frame untuk input dan tabel
        frame_stock = ttk.Frame(self.tab_stock)
        frame_stock.pack(fill='both', expand=True, padx=10, pady=10)

        # Frame untuk input (background warna light gray)
        frame_input = ttk.Frame(frame_stock, style="Custom.TFrame")
        ...
        self.tree_stock = ttk.Treeview(frame_stock, columns=columns, show='headings')
        for col in columns:
